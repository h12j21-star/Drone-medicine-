    ...
    const handleShoppingBasket = (item) =>{
     ...
     return (
        <div className='products__wrapper'>
            <Navigation/>
            <Search/>
            <Category categories={categories} currentCategory={currentCategory} onCategoryClicked={onCategoryClicked}/>
            <Product items={items} shoppingBasket={shoppingBasket} handleShoppingBasket={handleShoppingBasket}/>
            <Page activePage={currentPage} itemsCountPerPage={pageSize} totalItemsCount={totalItemsCount} onChange={handlePageChange} />
        </div>
    );
